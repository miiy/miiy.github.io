...
```bash
redis-cli -h redis -n 2 keys "goods_cache:getSub*" | xargs redis-cli -h redis -n 2 del
redis-cli -a "123456" -n 2 keys "goods_cache:getSub*" | xargs redis-cli  -a "123456" -n 2 del
```